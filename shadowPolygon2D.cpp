...
void ShadowPolygon2D::Update()
{

}

void ShadowPolygon2D::Draw()
{
	// 入力レイアウト設定
...
void ShadowPolygon2D::SetShadowColor(XMFLOAT4 color)
{
	m_Color = color;
}
